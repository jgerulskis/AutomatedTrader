...
def search(search_terms, MAX_RESULTS=100):
    url = 'https://api.twitter.com/2/tweets/search/recent?query=bitcoin&tweet.fields=created_at,public_metrics,lang&user.fields=public_metrics&max_results=' + str(MAX_RESULTS)
...
while (True):
    ...
    data = search(search_terms, MAX_RESULTS=11)
    if (data != None):
